...
<html>
<head>
<title>Labyrinth Lord Ranger Character Generator</title>
 
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    
	<meta charset="UTF-8">
	<meta name="description" content="Labyrinth Lord Ranger Character Generator. Goblinoid Games.">
	<meta name="keywords" content="Labyrinth Lord, Goblinoid Games,HTML5,CSS,JavaScript">
	<meta name="author" content="Mark Tasaka 2018">
		

	<link rel="stylesheet" type="text/css" href="css/ll_ranger.css">
	<link rel="stylesheet" type="text/css" href="css/ll_ranger_post.css">
...
<body>
    ...
    include 'php/rangerSpecial.php';
    include 'php/rangerSpells.php';
    ...
    $rangerSpecial = rangerMessage ($level);
    
    $druidSpellLv1 = druidLevel1Spell ($level);
    $druidSpellLv2 = druidLevel2Spell ($level);
    $druidSpellLv3 = druidLevel3Spell ($level);
    
    $magicUserSpellLv1 = magicUserLevel1Spell ($level);
    $magicUserSpellLv2 = magicUserLevel2Spell ($level);
...
<!-- JQuery -->
  <img id="character_sheet"/>
   <section>
      ...
      <span id="primeReq"></span>
       ...
       <span id="rangerMessageTitle">RANGER SPECIAL ABILITIES:</span>
       
       <span id="rangerMessage">
           <?php
           echo $rangerSpecial;
           ?>
       </span>
       ...
       <span id="spell1MagicUser">
           <?php
           echo $magicUserSpellLv1;
           ?>
       </span>
       
        
       <span id="spell2MagicUser">
           <?php
           echo $magicUserSpellLv2;
           ?>
       </span>
  ...
  <script>
	...
	/*
	 Character() - Ranger Character Constructor
	*/
	function Character() {
        ...
        let constitutionBase =  <?php echo rand(15, 18) ?>;
        ...
        let	wisdomBase =  <?php echo rand(12, 18) ?>;
		...
		let rangerCharacter = {
            ...
            "primeReqBonus": primeReq(strength, intelligence, wisdom),
	    ...
	    if(rangerCharacter.hitPoints <= 0 ){
			rangerCharacter.hitPoints = 1;
		}
		return rangerCharacter;
       ...
       let imgData = "images/ranger_character_sheet.png";
