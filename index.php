...
<html>
<head>
<title>Launch Page: Labyrinth Lord Ranger Generator</title>
...
<body>
	...
	<section>
		...
		<form action="" id ="rangerForm"  target="_blank" method="post">
            ...
            <span class="formIputDescription">Character Level:</span>	
			  <select id="level" name="theLevel" class="alignmentBox">	
				<option value="1" selected>1st Level, Ranger</option>
				<option value="2">2nd Level, Ranger</option>
				<option value="3">3rd Level, Ranger</option>
				<option value="4">4th Level, Ranger</option>
				<option value="5">5th Level, Ranger</option>
				<option value="6">6th Level, Ranger</option>
				<option value="7">7th Level, Ranger</option>
				<option value="8">8th Level, Ranger</option>
				<option value="9">9th Level, Ranger</option>
				<option value="10">10th Level, Ranger</option>
				<option value="11">11th Level, Ranger</option>
				<option value="12">12th Level, Ranger</option>
				<option value="13">13th Level, Ranger</option>
				<option value="14">14th Level, Ranger</option>
				<option value="15">15th Level, Ranger</option>
			  </select>
            ...
            <br/>
			  ...
			  <select id="chracterRace" name="theCharacterRace" class="alignmentBox">	
				...
				<option value="Half-Elf">Half-Elf (8)*</option>
			  </select>
                
               <p><span class="footnote2">&#42;Maximum demi-human ranger level.</span></p>
            ...
            <br/>
			  ...
			  <select id="hitDice" name="theHitDice" class="alignmentBox">	
               ...
               <p><span class="footnote2">&#42;&#42;2 Hit Dice at 1st level.</span></p>
			...
			<div class="generatorButtonA2">
                ...
                <script>
                    ...
                    $("#generate_characters2").click(function(){
                        ...
                        $("#rangerForm").attr('action', "character/ll_ranger_"+ $("#abilityScores").val() +  ".php");
